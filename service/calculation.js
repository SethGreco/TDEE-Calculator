...
function calculateBMR(gender, weight, feet, inches, age){
...
if (active === "Sedentary"){
  multiplier = 1.2
}else if(active === "Lightly") {
  multiplier = 1.375
}else if(active === "Moderatley"){
  multiplier = 1.55
...
module.exports = { calculateBMR, getHeight, convertWeight, activityLevel};